...
_G.packer_plugins = {
  ...
  ["base16-nvim"] = {
    loaded = true,
    path = "/home/devansh-bhavsar/.local/share/nvim/site/pack/packer/start/base16-nvim",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/devansh-bhavsar/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["opencode.nvim"] = {
    loaded = true,
    path = "/home/devansh-bhavsar/.local/share/nvim/site/pack/packer/start/opencode.nvim",
